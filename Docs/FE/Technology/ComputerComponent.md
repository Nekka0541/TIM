...
### プリンタ
- レーザープリンタ
  - 光伝導物質を表面に塗布した感光ドラムにレーザ光を当てて像を作りドラムに付着したトナーを紙に転写して印刷する。
- インクジェットプリンター
...
#### Zigbee
Bluetoothよりも電波の距離が狭く、通信速度も最大で250kbpsと遅いが、低コストで低消費電力が特徴
LANよりも狭い、数ｍ程度の近距離のIＴ機器同士が通信するネットワークを**PAN(Personal Area Network)**という。