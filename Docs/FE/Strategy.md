...
- [ストラテジ系](#ストラテジ系)
  ...
  - [会計・財務](#会計財務)
    ...
    - [減価償却](#減価償却)
    - [在庫評価](#在庫評価)
  - [知的財産権とセキュリティ関連法規](#知的財産権とセキュリティ関連法規)
    - [知的財産権](#知的財産権)
    - [著作権](#著作権)
      - [コンピュータに関する著作物](#コンピュータに関する著作物)
    - [産業財産権](#産業財産権)
    - [不正競争防止法](#不正競争防止法)
    - [セキュリティ関連法規](#セキュリティ関連法規)
      - [サイバーセキュリティ基本法](#サイバーセキュリティ基本法)
      - [不正アクセス禁止法](#不正アクセス禁止法)
      - [プロバイダ責任制限法](#プロバイダ責任制限法)
      - [コンピュータ犯罪と刑法](#コンピュータ犯罪と刑法)
  - [労働・取引関連法規と標準化](#労働取引関連法規と標準化)
...
## 会計・財務
### 管理会計と財務会計
企業会計は「内部に対してのか報告」である管理会計と、「外部に対しての報告」である財務会計に分かれる。

#### 管理会計
- 企業内部の意思決定や組織統制が目的
- 損益分岐点分析や原価管理、予算管理など、経営判断のための内部報告書を作成します。

#### 財務会計
- ステークホルダ（利害関係者）に対して会計報告を行うことが目的
...
- 損益分岐点での売上高（損益分岐点売上高）は、変動費と固定費の和に等しくなる。
  - 損益分岐点売上高=固定費＋変動費
...
- B/S(Balance Sheet)とも呼ばれています。
- その時点での会社の財産や借金はいくらあるの?ということ
![](2024-04-14-10-53-58.png)

- 資産、負債、純資産の３つは以下の関係式が成り立つ
  - 資産=負債+純資産
...
- P/L(Profit and Loss statement)　その期間にいくら儲かった？損した？のこと
- 売上高から費用を除けば利益が求まるが、どこまで差し引くかによって５段階の利益がある。
  1. 売上総利益
     1. 売上高-売上原価
  2. 営業利益
     1. 売上総利益ー販売費及び一般管理費
...
#### キャッシュフロー計算書
- 会計期間における現金の流れを示したもの
- 営業活動、投資活動、財務活動の3活動区分に分けて表す。
  - 営業活動によるキャッシュフロー
    - 営業活動による現金の増減を表したもの。
    - 増加要因　商品の販売、棚卸資産の減少など
    - 減少要因　商品の仕入れ、給与の支払いなど
  - 投資活動によるキャッシュフロー
    - 投資活動による現金の増減を表したもの
    - 増加要因　固定資産の売却、有価証券の売却など
    - 減少要因　固定資産の取得、
  - 財務活動によるキャッシュフロー
    - 資金の調達や返済による現金の増減を表したもの
    - 増加要因　借入、社債の発行、株式の発行など
    - 減少要因　借入金の返済、社債の償還、配当金の支払いなど
#### NPV
- NetPresentValue
  - 投資によってどれだけの利益が得られるかを示す指標
  - 正味現在価値とも訳される
  - この値が大きいほど投資効果が高く、マイナスであれば投資の採算が取れないと判断する。
  - 将来価値=現在価値（PV）×（１＋利率）^ｎ年後
    - PVは受け取ることができる価値を現在の価値に換算したもの
  - 正味現在価値（NPV）＝現在価値（ＰＶ）の合計ー初期投資額

### 減価償却
- 資産の購入にかかった金額（取得価額）を一定の方法に従って利用した年度ごとに減価償却費として計上していく方法
  - 取得した年度に全額を計上すると、その年度だけ支出が急に増えてしまい、正確な経営状況がつかめなくなるから
- 法定耐用年数
  - 資産の利用可能な年数を耐用年数といい、資産の種別ごと法定耐用年数として定められている。
- 減価償却の方法
  - 定額法
    - 毎年同じ金額意を計上する
  - 定率法
...
### 在庫評価
- 先入先出法
  - 先に仕入れた商品から先に売れたものとみなして、払い出し単価とする
- 移動平均法
  - 商品を購入した都度、その時の在庫金額と購入価額との合計額を在庫数量と購入数量との合計数量で割り、払出単価とする方法
- 総平均法
...
### 著作権
- 著作権は文芸や学術、美術、音楽の範囲に属する著作物の利用について、著作者が独占的・排他的に支配して利益を受ける権利。
- 著作物を捜索した時点から権利が発生し、個人では死後７０年間保護される。
- 著作権は著作者人格権と著作財産権に分けられる。  
  - 著作人格権
    - 公表権・氏名表示権・同一性保持権など
  - 著作財産権
    - 複製権・貸与権・頒布権など
...
#### コンピュータに関する著作物
- プログラム、マニュアル、Webページ等も著作権の対象になる

### 産業財産権
特許庁に出願・審査・登録することによって権利が発生する。
産業財産権には次のようなものがある。
![](2024-09-21-11-43-07.png)

### 不正競争防止法
不正競争防止法は、 事業活動に有用な技術上または営業上の秘密として管理されている情報を保護し、不正な競争を防止することを目的とした法律
- この法律により、模倣、不正使用に対して差止請求也損害賠償請求ができる。
- 営業秘密とは次の３つの要件を満たすもの
      1. 秘密として管理されているもの
      2. 事業活動に有用な技術または情報であるもの
      3. 公然と知られていないもの
...
#### 不正アクセス禁止法
不正アクセス禁止法は、ネットワークに接続され、かつアクセス制限機能を持つコンピュータに対して、不正なアクセスを禁止する法律

####　個人情報保護法
個人情報保護法は、個人情報の不適切な取扱いによって、個人の権利利益が侵害されないようにすることを目的とした法律

#### プロバイダ責任制限法
プロバイダ責任制限法は、インターネット上で誹謗中傷などがあった場合は、プロバイダの責任の範囲や削除請求、発信者情報開示請求ができる権利を定めた法律
- 開示請求されたプロバイダは、発信者に開示するかどうか聴取する。開示拒否の場合は請求者は裁判所に開示請求することができる。

#### コンピュータ犯罪と刑法
- 刑法によって処罰対象となるコンピュータ犯罪に、通称、「ウイルス作成罪」がある。
- コンピュータ使用時に意図していない不正な指令を与える電磁的記録を作成したリ、提供や供用、取得、保管したりすることが処罰の対象
